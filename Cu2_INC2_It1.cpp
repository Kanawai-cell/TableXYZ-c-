// CU2_INC2_IT1.cpp : définit le point d'entrée pour l'application console.
...
int _tmain(int argc, _TCHAR* argv[])
{
  ...
  string Trace("TraceCU2_INC2_IT1.txt");
